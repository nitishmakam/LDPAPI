...
def generate():
    ...
    features = [
        ...
        "DAYS_EMPLOYED", "AMT_ANNUITY", "AMT_CREDIT", "AMT_GOODS_PRICE",
        "DAYS_ID_PUBLISH", "DAYS_REGISTRATION", "DAYS_LAST_PHONE_CHANGE",
        "AMT_INCOME_TOTAL", "OWN_CAR_AGE", "REGION_POPULATION_RELATIVE",
        ...
        "BASEMENTAREA_MODE", "REGION_RATING_CLIENT_W_CITY", "APARTMENTS_MODE",
        "LANDAREA_AVG", "BASEMENTAREA_AVG", "DEF_60_CNT_SOCIAL_CIRCLE",
        "CODE_GENDER", "LANDAREA_MODE", "AMT_REQ_CREDIT_BUREAU_MON",
        "YEARS_BEGINEXPLUATATION_MEDI", "REG_CITY_NOT_LIVE_CITY",
        "NONLIVINGAREA_MEDI", "LANDAREA_MEDI", "BASEMENTAREA_MEDI",
        "COMMONAREA_MEDI", "YEARS_BEGINEXPLUATATION_AVG", "LIVINGAREA_MEDI",
        "CNT_FAM_MEMBERS"
    ]
    row = []
    ...
    for mf in modelfiles:
        models.append(
            lgb.Booster(
                model_file=os.path.join(app.root_path, 'files/%s' % mf)))
    preds = []
    for model in models:
